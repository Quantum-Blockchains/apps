...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  {
    info: 'quantum-technologies-platform',
    providers: {
      'Quantum Technologies Platform': 'wss://qsb.qbck.io:9945'
    },
    text: 'Quantum Technologies Platform',
    ui: {
      color: '#00CCAB',
      logo: chainsQchainPNG
    }
  },
  {
    info: 'nodle',
